...
def login_lagi334():
	...
	try:
		...
		cetak(nel('\t            𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎I : [green]𝐌-𝐔𝐋𝐋𝐀𝐇'𝐒 𝐖𝐎𝐑𝐋𝐃[purple] '))
...
def setting():
	...
	cetak(nel('[bold yellow]ðŸ‡®ðŸ‡©âž£1. Clone Old \nðŸ‡®ðŸ‡©âž£2. Clone New\nðŸ‡®ðŸ‡©âž£3. Clone Random [bold yellow]'))
...
#		taplikasi.append('no')
	...
	pwplus=input('âž¥âž¥âž Use Password Manual/depault( m/d ) ')
